export default function StatCard({ label, value, icon: Icon, loading = false }) {
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm sm:p-6">
